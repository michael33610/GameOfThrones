...
class Royaume
{
    ...
    */
     ...
     * Add personnages
     *
     * @param \wcs\GameOfThronesBundle\Entity\Personnage $personnages
     * @return Royaume
     */
    public function addPersonnage(\wcs\GameOfThronesBundle\Entity\Personnage $personnages)
    {
     ...
     * @param \wcs\GameOfThronesBundle\Entity\Personnage $personnages
     */
    public function removePersonnage(\wcs\GameOfThronesBundle\Entity\Personnage $personnages)
    {
